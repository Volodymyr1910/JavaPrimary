package Day6.ait.supermarket_hashset.test;

import Day6.ait.supermarket_hashset.dao.Supermarket;
import Day6.ait.supermarket_hashset.dao.SupermarketImplementation;
...
class SupermarketImplementationTest {
    ...
    void removeProductTest() {
        ...
        Assertions.assertNull(supermarket.removeProduct(222222)); // дважды не можем удалить
    }//end removeProductTest

    @Test
    void findByBarCodeTest() {
        assertEquals(products[1], supermarket.findByBarCode(222222));
        Assertions.assertNull(supermarket.findByBarCode(888888));
    ...
    void findByCategoryTest() {
        ...
        Iterable<Product> expected = Arrays.asList(products[2], products[3], products[1]);
        Assertions.assertIterableEquals(expected, actual);

        //но правильно чтоб список строился по порядку, для этого нужно ХешСет перевести в Лист, отсортировать, вернуть в ХешСет
