...
class ArchiveTest {
    ...
    void findTheOldestDocuments() {
        ...
        Document arrayOldestDocumentsTest[] = new Document[2]; // создаем массив с самыми старыми документами
    ...
    void findAllDocumentsThisAutorTest() {
        ...
        Document thisAutorDocumentsArrayTest[] = new Document[1]; //создаем массив куда попадают документы искомого автора ТЕСТ
