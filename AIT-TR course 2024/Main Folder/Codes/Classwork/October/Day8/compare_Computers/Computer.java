...
public class Computer {
    ...
    public boolean equals(Object o) {
        if (this == o) return true; // сравниаваем значения обьекта сами с собой, если равны то получаем true
        if (!(o instanceof Computer computer)) return false; // это обьект не из класса Computer, то получаем false
