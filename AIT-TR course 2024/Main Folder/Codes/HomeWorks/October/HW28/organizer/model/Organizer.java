...
public enum Organizer {
    ...
    ADDnewTASK (1, "Add a new task."), SEEallTASKS (2, "See the tasks list."), REMOVE_TASK (3, "Remove the task."), EXIT (4, "Go to the previous menu.")
    ;
    ...
    public static void printMenu (){
        System.out.println("-------------------Choose action by pressing number 1 - 4: -----------------------");
